            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" id="user-name">Unknown</span>
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="user" id="form-update" enctype="multipart/form-data">
                                @csrf
        ...
        function getUserById(userId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#foto-user').html(`
                        <img src="/storage/images/${response.data.foto}" alt="foto-user" height="150px" width="150px">
                    `);
                },
                error: function(xhr, status, error) {
                    if (xhr.status === 401) {
