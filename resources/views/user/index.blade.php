                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small" id="user-name">Douglas
                                    McGee</span>
                            </a>
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type) {
                            return `<img src="/storage/images/${data}" height="100px" width="100px" alt="foto user">`
                        }
                    },
                    {
                        "data": "id",
                        "render": function(data, type) {
                            return `
                                <a href="/users/${data}" class="btn btn-warning btn-sm">Edit</a>
                                <button onclick="deleteUserById(${data})" class="btn btn-danger btn-sm">Delete</button>
                            `;
                        }
                    }
                ]
